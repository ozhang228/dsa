...
every second, two things happen
  choose a trash bag and destroy, 1 choice is weight is greater than c, else 0
  weight of every remaining trash bag will get multiplied by 2

always choose the biggest that is less than c, n^2
**/
